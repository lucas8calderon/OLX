...
import com.lucascalderon1.olx.api.CEPService;
import com.lucascalderon1.olx.helper.FirebaseHelper;
import com.lucascalderon1.olx.helper.GetMask;
import com.lucascalderon1.olx.model.Anuncio;
import com.lucascalderon1.olx.model.Categoria;
import com.lucascalderon1.olx.model.Endereco;
...
public class FormAnuncioActivity extends AppCompatActivity {
    ...
    public void selecionarCategoria(View view) {
        Intent intent = new Intent(this, com.lucascalderon1.olx.activitys.CategoriasActivity.class);
        ...
        enderecoRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    startActivity(new Intent(getBaseContext(), com.lucascalderon1.olx.activitys.EnderecoActivity.class));
                    finish();
                }
            }
